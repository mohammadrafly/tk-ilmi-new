...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Create New Guru</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.guru.create') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="no_telp" type="number" name="no_telp" value="{{ old('no_telp') }}"
