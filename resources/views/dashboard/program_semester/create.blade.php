...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Create New Program Semester</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.programsemester.create') }}">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <select id="tahun_ajaran" name="tahun_ajaran" class="w-full border {{ $errors->has('tahun_ajaran') ? 'border-red-500' : 'border-gray-300' }} shadow-sm px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#f18e00] focus:border-transparent">
                    ...
                    <option value="{{ $tahun->id}}" {{ old('tahun_ajaran') == '1' ? 'selected' : '' }}>{{ $tahun->tahunawal }}-{{ $tahun->tahunakhir}}</option>
                    @endforeach
                </select>
                @error('tahun_ajaran')
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="topik" type="text" name="topik" value="{{ old('topik') }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="minggu1" type="text" name="minggu1" value="{{ old('minggu1') }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="minggu2" type="text" name="minggu2" value="{{ old('minggu2') }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="minggu3" type="text" name="minggu3" value="{{ old('minggu3') }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="minggu4" type="text" name="minggu4" value="{{ old('minggu4') }}"
