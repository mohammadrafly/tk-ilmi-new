...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Edit Kategori Transaksi</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.kategori.edit', $kategoriTransaksi->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="nama" type="text" name="nama" value="{{ old('nama', $kategoriTransaksi->nama) }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="harga" type="number" name="harga" value="{{ old('harga', $kategoriTransaksi->harga) }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="interval" type="number" name="interval" value="{{ old('interval', $kategoriTransaksi->interval) }}"
