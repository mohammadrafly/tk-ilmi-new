...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Edit Tahun Ajaran</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.tahunajaran.edit', $tahunAjaran->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="tahunawal" type="number" name="tahunawal" value="{{ old('tahunawal', $tahunAjaran->tahunawal) }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="tahunakhir" type="number" name="tahunakhir" value="{{ old('tahunakhir', $tahunAjaran->tahunakhir) }}"
                       ...
                       placeholder="Enter End Year" min="1900" required>
                @error('tahunakhir')
                    <div class="text-red-500 text-sm mt-2">{{ $message }}</div>
                @enderror
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTahunAkhir() {
        ...
        if (!isNaN(tahunAwal)) {
            tahunAkhirInput.min = tahunAwal + 1;
    ...
    tahunAwalInput.addEventListener('input', updateTahunAkhir);
