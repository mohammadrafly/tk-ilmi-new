...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold text-[#051951] mb-4">Add New Role</h1>

    <form action="{{ route('dashboard.roles.create') }}" method="POST" class="bg-white shadow-md rounded-md p-6 space-y-6">
        @csrf
