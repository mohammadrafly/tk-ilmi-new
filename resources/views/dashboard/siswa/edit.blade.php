...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Edit Siswa</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.siswa.edit', $siswa->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                ...
                @if ($siswa->foto_akte_kelahiran)
                    <div class="mt-2">
                        <img src="{{ Storage::url($siswa->foto_akte_kelahiran) }}" alt="Current birth certificate" class="w-32 h-32 object-cover">
                    </div>
                @endif
