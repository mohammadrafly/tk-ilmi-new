...
<div class="bg-white p-8 min-w-[600px] mx-auto">
    <div class="text-2xl font-bold mb-6 text-center text-[#051951]">Create New Siswa</div>
    <hr class="mb-6">

    <form method="POST" action="{{ route('dashboard.siswa.create') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <select id="agama_id" name="agama_id"
                        ...
                        required>
                    <option value="" disabled>Select Agama</option>
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="nama_orang_tua" type="text" name="nama_orang_tua" value="{{ old('nama_orang_tua') }}"
        ...
        <div class="mb-6">
            ...
            <div class="mt-2">
                <input id="alamat_orang_tua" type="text" name="alamat_orang_tua" value="{{ old('alamat_orang_tua') }}"
